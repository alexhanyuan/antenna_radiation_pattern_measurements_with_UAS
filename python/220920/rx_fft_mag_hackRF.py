...
class rx_fft_mag_hackRF(gr.top_block):

    def __init__(self, RF_gain=32, filename='data_woo_ya', frequency=446200000, num_buffers=10, samp_rate=1000000):
        gr.top_block.__init__(self, "rx_fft_mag")
...
def argument_parser():
    ...
    parser.add_argument(
        "--frequency", dest="frequency", type=intx, default=446200000,
...
def main(top_block_cls=rx_fft_mag_hackRF, options=None):
    if options is None:
