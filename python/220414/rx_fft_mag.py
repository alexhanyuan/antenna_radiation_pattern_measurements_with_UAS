...
class rx_fft_mag(gr.top_block):
    ...
    def __init__(self, RF_gain=32, filename='data_woo_ya', frequency=446000000, num_buffers=10, samp_rate=1000000):
        ...
        # Variables
        ##################################################
        self.offset = offset = 6924
        self.num_points = num_points = 10240
        self.m = m = 512
